...
export const getProduct =
  ...
  async (dispatch) => {
    try {
      ...
      let link = `http://localhost:8000/api/v1//product?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&rating[gte]=${ratings}`;
      if (category) {
        link = `http://localhost:8000/api/v1//product?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&rating[gte]=${ratings}`;
      }
